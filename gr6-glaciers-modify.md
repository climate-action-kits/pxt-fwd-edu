...
After each change to the code, you will need to ``|Download|`` the updated code for your project.

## Modify Step 1 

In this project, we are tracking the levels of light being reflected off different surfaces. We do this by using something called conditionals.
...
## Modify Step 2 
Did you guess correctly? The code below has only one conditional statement. This condition is triggered by an event.
...
## Modify Step 3 
Did you guess that right? ``||Input:on button A pressed||`` is an Event block. <br> 
...
```
## Modify Step 6 
First, let’s get our materials ready. You will need:
Two pieces of paper: one white and one black
